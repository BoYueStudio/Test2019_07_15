    ...
    <div class="loginbox">
        ...
        <div class="conlist">
            ...
            <form  action="${pageContext.request.contextPath}/regist" method="post">
                <p>
                    <div class="fl res-text">用户名：</div><div><input type="text"  name="uname"  placeholder="请输入账号" class="loginuser"></div>
                </p>
                <p>
                   <div class="fl res-text">昵称：</div><div><input type="text" name="upet"  placeholder="请输入昵称" class="loginuser"></div>
                </p>
                <p>
                   <div class="fl res-text">密码：</div><div><input type="password" name="upwd"  placeholder="请输入密码" class="loginuser"></div>
                </p>
