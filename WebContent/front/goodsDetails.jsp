...
<div class="nofix_head">
    <div class="top wrapper">
        <div class="float-lt margin-b10">
            <ul>
                	...
                	<c:if test="${empty sessionScope.user}">
						<li><a href="${pageContext.request.contextPath}/front/login.jsp"
							class="green">请登录</a></li>
						<li><a href="${pageContext.request.contextPath}/front/regist.jsp"
							class="green">免费注册</a></li>
					</c:if>
					<c:if test="${not empty sessionScope.user}">
						<li><a href="javascript:;" class="green">您好，${sessionScope.user.pet_Name}</a></li>
						<li><a
        ...
        <div class="float-rt">
            <ul>
                <li><a href="${pageContext.request.contextPath}/frontallgoods" target="_blank">首页</a></li>
                <li><a href="">我的小充</a></li>
...
<div class="sup-wid">
    ...
    <div class="pro_detail" >
        <div class="pro_detail_img float-lt">
            <div class="gallery">
                <div class="tb-booth tb-pic tb-s310"> <a href="images/01.jpg"><img src="${requestScope.goods.goods_Pic}"  alt="展品细节展示放大镜特效" rel="${requestScope.goods.goods_Pic}" class="jqzoom" /></a> </div>
                <ul class="tb-thumb" id="thumblist">
                   <!--  <li class="tb-selected">
                        <div class="tb-pic tb-s40"><a href="javascript:;"><img src="images/01_small.jpg" mid="images/01_mid.jpg" big="images/01.jpg"></a></div>
                    </li>
                    <li>
                        <div class="tb-pic tb-s40"><a href="javascript:;"><img  src="images/02_small.jpg"  mid="images/02_mid.jpg" big="images/02.jpg"></a></div>
                    </li>
                    <li>
                        <div class="tb-pic tb-s40"><a href="javascript:;"><img src="images/03_small.jpg"  mid="images/03_mid.jpg" big="images/03.jpg"></a></div>
                    </li>
                    <li style="margin-right:0px;">
                        <div class="tb-pic tb-s40"><a href="javascript:;"><img src="images/04_small.jpg"  mid="images/04_mid.jpg" big="images/04.jpg"></a></div>
                    </li> -->
                </ul>
            </div>
            <script type="text/javascript">
...
<!--             <input type="button" value="加入收藏" id="h1" class="addcart" onclick="ShowDiv('MyDiv2','fade2')" /> -->
        ...
        <div class="float-lt pro_detail_con">
            <div class="pro_detail_tit">${requestScope.goods.goods_Name }</div>
            <div class="pro_detail_ad">${requestScope.goods.desc}</div>
            ...
            <div class="clear"></div>
            <div class="pro_detail_price  margin-t20"><span class="margin-r20">市场价</span><span style=" font-size:16px"><s>￥${requestScope.goods.goods_Price }</s></span></div>
            <div class="clear"></div>
            <div class="pro_detail_act margin-t20 fl"><span class="margin-r20">售价</span><span style="font-size:26px; font-weight:bold; color:#dd514c;">￥${requestScope.goods.goods_Price }</span></div>
            <div class="clear"></div>
            ...
            <div class="pro_detail_number margin-t30">
                ...
                <div class=""> <i class="jian"></i>
                    ...
                    <i class="jia"></i> <span>&nbsp;盒</span> <span>（库存${requestScope.goods.goods_Num}盒）</span> </div>
                <div class="clear"></div>
            </div>
            <!-- <div class="guige">
            ...
            <div class="pro_detail_btn margin-t30">
                <ul>
                    ...
                    <li class="pro_detail_add"><a href="${pageContext.request.contextPath}/cargoods?method=addcar&id=${requestScope.goods.goods_Id}" onclick="ShowDiv('MyDiv','fade')">加入购物车</a></li>
                </ul>
            </div>
        </div>
...
<div class="fri-link-bg">
    <div class="fri-link">
        ...
        <ul class="link-add float-lt ma">
            <li><a href="javascript:;" class="font14">网站栏目</a></li>
            <li><a href="javascript:;">网站栏目</a></li>
            <li><a href="javascript:;">网站栏目</a></li>
            <li><a href="javascript:;">网站栏目</a></li>
        </ul>
